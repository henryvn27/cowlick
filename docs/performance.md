...
Presentation latency was measured from spawning the bundled helper until a NotchRelay-owned on-screen window appeared through Core Graphics. The cold sample includes first-use process, socket, filesystem, and SwiftUI work. These numbers describe this machine and are not a claim about every supported Mac.
