...
enum SocketServerError: LocalizedError {
  ...
  var errorDescription: String? {
    ...
    case .alreadyRunning: "Another NotchRelay instance is already serving bridge requests."
    case .unsafeExistingSocketPath:
...
final class LocalSocketServer: @unchecked Sendable {
  ...
  private let logger = Logger(subsystem: "com.henryvn27.NotchRelay", category: "Socket")
  private let acceptQueue = DispatchQueue(
    label: "com.henryvn27.NotchRelay.socket.accept", qos: .userInitiated)
  private let clientQueue = DispatchQueue(
    label: "com.henryvn27.NotchRelay.socket.clients", qos: .userInitiated,
